...
struct proc
{
	...
	int slot;					// Rest of time slot 
	int priority;				// Process priority (0-20)=(highest-lowest)

	// about share memory 
	uint shm;					// The low-boundary address of share memory 
	uint shmkeymask;			// The mask of using shared physical memory page 
	void *shmva[ MAX_SHM_NUM ];			// The starting virtual address list of shared memory 
